INSERT INTO `test-db`.`usuarios` (id, nome, email, senha) VALUES
...
INSERT INTO `test-db`.`eventos` (id, titulo, descricao, data, tipo, usuario_id) VALUES
...
INSERT INTO `test-db`.`enderecos` (id, local, estado, cidade, rua, numero, evento_id) VALUES
...
INSERT INTO `test-db`.`arquivos` (id, nome, caminho, tipo, evento_id) VALUES
...
INSERT INTO `test-db`.`imagens` (id, nome, caminho, eventos_id) VALUES
...
-- Notificações
INSERT INTO `test-db`.`notificacoes` (id, titulo, corpo, data) VALUES
...
-- Datas Especiais
INSERT INTO `test-db`.`datas_especiais` (id, data, usuarios_id) VALUES
...
-- Amizades
INSERT INTO `test-db`.`amizades` (id, usuarios_id, amigo_id, status) VALUES
...
INSERT INTO `test-db`.`usuario_evento` (usuarios_id, eventos_id) VALUES
...
INSERT INTO `test-db`.`notificacao_usuario` (notificacao_id, usuario_id) VALUES
...
INSERT INTO `test-db`.`requisitos` (id, titulo, descricao, evento_id) VALUES
...
INSERT INTO `test-db`.`chats` (id, nome, evento_id) VALUES
...
INSERT INTO `test-db`.`convites` (id, titulo, descricao, evento_id) VALUES
